...
import (
	...
	viewv1 "github.com/srn221b/markdown-view/api/v1"
)
...
// +kubebuilder:webhook:path=/mutate-view-srn221b-github-io-v1-markdownview,mutating=true,failurePolicy=fail,sideEffects=None,groups=view.srn221b.github.io,resources=markdownviews,verbs=create;update,versions=v1,name=mmarkdownview-v1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-view-srn221b-github-io-v1-markdownview,mutating=false,failurePolicy=fail,sideEffects=None,groups=view.srn221b.github.io,resources=markdownviews,verbs=create;update,versions=v1,name=vmarkdownview-v1.kb.io,admissionReviewVersions=v1
